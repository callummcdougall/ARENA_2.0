...
ray_segment_batch = (solutions.rays1d, solutions.segments)
...
@pytest.mark.parametrize(
    "rays, segments", [ray_segment_batch, ray_segment_special_case]
)
...
@pytest.mark.parametrize(
    "rays, segments", [ray_segment_batch, ray_segment_batch_special_case]
)
...
@pytest.mark.parametrize("A, B, C, rays", [triangle_and_rays])
