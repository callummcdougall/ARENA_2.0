...
def main(args):
    ...
    # imagenet_dataloader = DataLoader(imagenet_valset, shuffle=True, batch_size=32, num_workers=4, pin_memory=True, pin_memory_device='cuda:'+str(0 if UNIGPU else rank))
    ...
    dataloader = DataLoader(imagenet_valset, shuffle=True, batch_size=32, pin_memory=True, pin_memory_device='cuda:'+str(0 if UNIGPU else rank))
    resnet34 = resnet34.to(device='cuda:'+str(0 if UNIGPU else rank))
    losses = []
    accuracies = []
