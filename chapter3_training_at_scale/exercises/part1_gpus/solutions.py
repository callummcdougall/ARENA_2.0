...
from typing import List, Optional, Callable, Tuple, Dict, Literal, Set, NamedTuple 
...
if MAIN:
    tests.test_daxpy_random_input(daxpy, fused_daxpy)
...
if MAIN:
    tests.test_calc_scale_zero_point(calcScaleZeroPoint)
# %%
...
if MAIN:
    tests.test_quantize_layer(quantizeLayer)
