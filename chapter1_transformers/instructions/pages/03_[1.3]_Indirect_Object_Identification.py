...
if MAIN:
    model = ioi_circuit_extraction.add_mean_ablation_hook(model, means_dataset=abc_dataset)
...
if MAIN:
    model = add_mean_ablation_hook(model, means_dataset=abc_dataset)
...
func_page_list = [
    ...
    (section_5, '5️⃣ Bonus / exploring anomalies'),
